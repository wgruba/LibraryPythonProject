...
class UserActions(tk.Frame):
    ...
    def __init__(self, master):
        ...
        self.LoadUser()
        Label(frame, text="loged as: " + self.User.login, bg='black', fg='white', font=('Courier', 8)).place(relx=0.0,rely=0.0,relwidth=0.2,relheight=0.05)
        ...
        if self.User.ReadedBooks != {}:
            ...
            Label(frame, text=book1[ran][0].name, bg='black', fg='white', font=('Courier', 15)).place(relx=0.05, rely=0.55,relwidth=0.25,relheight=0.05)
            ran = random.randrange(0, len(book1))
            ...
            Label(frame, text="Ooops you dont have any book", bg='black', fg='white', font=('Courier', 15)).place(relx=0.30, rely=0.25,relwidth=0.50, relheight=0.1)
